...
**negative 를 버리려는 이유**
- negative sample 을 정의하기 어려운 도메인이 많음
...
1. 배치 크기와 augmentation 선택에 덜 민감함을 실험으로 확인
...
1. predictor 의 최종 출력 차원이 target 의 projection 출력 차원과 같으므로 두 값을 직접 비교할 수 있음
1. 그 차이를 loss 로 줄임
...
- 두 view 에 서로 다른 augmentation 분포를 적용
