...
> 📄 [**EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks**](https://arxiv.org/abs/1905.11946) · ICML 2019 · Tan, Le

## Abstract

**문제**
CNN은 고정된 자원 예산에서 개발되고, 자원이 더 있으면 키워서 성능을 올림. 그런데 **어떻게 키울지**는 임의로 정해져 왔고, 보통 depth·width·resolution 중 **하나만** 늘림
...
![Figure 2](/img/efficientnet/f2.png)
...
![Figure 3](/img/efficientnet/f3.png)
...
- φ 를 지수로 올리는 이유는 **세 파라미터를 동일한 비율로 함께 증가**시키기 위해
...
![Table 1](/img/efficientnet/t1.png)
...
![Figure 5](/img/efficientnet/f5.png)
...
*`f`·`t` 로 시작하는 그림은 원 논문에서 가져왔다. Tan & Le, [EfficientNet](https://arxiv.org/abs/1905.11946), ICML 2019.*
