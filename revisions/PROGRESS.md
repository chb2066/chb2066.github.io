...
| 18 | `bert` | 1810.04805 | **완료** |
| 19 | `sam` | 2304.02643 | **완료** |
| 20 | `resnet` | 1512.03385 | **완료** |
| 21 | `unet` | 1505.04597 | **완료** |
| 22 | `swav` | 2006.09882 | **완료** |
| 23 | `ae-vae` | 1312.6114 | **완료** |
| 24 | `simsiam` | 2011.10566 | **완료** |
| 25 | `byol` | 2006.07733 | **완료** |
...
| 2026-09-10 | `bert` | 80/10/10 배분의 이유 보강. 오타 수정. GLUE·SQuAD 결과 신설 |
| 2026-09-10 | `sam` | 번역이 깨진 모델 구성 재작성. 모호성 처리(마스크 3개·최소 손실 역전파) 신설 |
| 2026-09-10 | `resnet` | degradation 이 과적합이 아님을 명확히. ILSVRC 2015 결과 신설. FLOPs 계산은 유지 |
| 2026-09-10 | `unet` | Overlap-Tile 의 mirroring 보강. weight map 목적 명확화. ISBI 2015 우승 등 결과 |
| 2026-09-10 | `swav` | swapping 설계 의도·온라인 Sinkhorn 보강. linear 75.3% |
| 2026-09-10 | `ae-vae` | reparameterization trick·ELBO 신설. KL 논증은 유지 |
| 2026-09-10 | `simsiam` | stop-gradient 제거 시 즉시 붕괴하는 실험·EM 해석 보강. 「생각해볼만한 것」 유지 |
| 2026-09-10 | `byol` | online/target 용어 정리. 붕괴하지 않는 이유 확장. linear 74.3% |
...
논문 PDF 를 전부 받아 대조했고, 확인 못 한 내용은 넣지 않았다.
각 개정본 맨 위 HTML 주석에 무엇을 왜 고쳤는지 적어두었다.
